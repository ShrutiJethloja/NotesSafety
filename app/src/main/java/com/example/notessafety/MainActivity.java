...
import com.example.notessafety.Adapters.NotesListAdapter;
import com.example.notessafety.Database.RoomDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent, 101);      //for adding a note = 101 and for deleting a note = 102
            }
        });
